...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "SmartSipImplementation", url: "https://github.com/smartconnect-eu/SmartSIP-SDK-Libraries-and-Examples/releases/download/0.0.73/SmartSipImplementation-0.0.73.xcframework.zip", checksum: "69614771c476d34a47ca0472b513b0f46d57f164abe443005f6d5951ac72c7b9")
    ]
)
