...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "SmartSipImplementation", url: "https://github.com/smartconnect-eu/SmartSIP-SDK-Libraries-and-Examples/releases/download/0.0.80/SmartSipImplementation-0.0.80.xcframework.zip", checksum: "e8ee74b0d6852a1810e4c528cb04f1b58ce696367a22f1a90cbba574d3c55229")
    ]
)
