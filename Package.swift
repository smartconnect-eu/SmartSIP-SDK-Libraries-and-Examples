...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "SmartSipImplementation", url: "https://github.com/smartconnect-eu/SmartSIP-SDK-Libraries-and-Examples/releases/download/0.0.63/SmartSipImplementation-0.0.63.xcframework.zip", checksum: "436305c927077cac1f34a2ddcb4f910b38defcabe73060887c18f67947a62a03")
    ]
)
