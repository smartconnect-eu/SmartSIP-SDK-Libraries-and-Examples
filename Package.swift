...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "SmartSipImplementation", url: "https://github.com/smartconnect-eu/SmartSIP-SDK-Libraries-and-Examples/releases/download/0.0.44/SmartSipImplementation-0.0.44.xcframework.zip", checksum: "67da2805785038bd6420d51f979ff9554672d766547d6d481911d250af82f083")
    ]
)
